...
const PortfolioCard = ({ data }) => {
    return (
        <div className="card_stylings overflow-hidden h-full rounded-xl shadow-lg bg-zinc-900">
            ...
            <div
                id="arrow"
                className="py-2 px-6 hover:-translate-y-2 transition-all ease-in-out duration-500"
            >
